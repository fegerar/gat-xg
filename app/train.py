...
from classes import GraphSoccerDataset, GraphAttentionNetwork
...
def main():
    ...
    # Load dataset with whole graphs
    dataset = GraphSoccerDataset(
        pickle_path='../dataset/processed_data.pkl',
        normalize_coordinates=True,
        final_graph_only=False  # Use the merged graph from the whole possession
    )
